#!/usr/bin/env bash
# wget -qO- https://raw.githubusercontent.com/naiemk/vibed-infra/main/examples/vps-hello/install/install-gateway.sh | bash
set -euo pipefail
...
export PACKAGER_RAW PACKAGECONFIG_URL PRODUCT_RAW INFRA_PROFILE=gateway INSTALL_DIR="${INSTALL_DIR:-.}"
